...
class _TicTacToeScreenState extends ConsumerState<TicTacToeScreen> {
          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  color:
                      (state.isMyTurn && !isFinished && !isDisconnected)
                          ? AppColors.primary
  ...
  void _quitGame(TicTacToeState state) {
    final app = ref.read(appControllerProvider);
    // Drop any still-pending moves for this game BEFORE sending the end, so
    // stale packets stop retransmitting but the end itself still goes out.
